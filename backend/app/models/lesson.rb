class Lesson < ApplicationRecord
  ...
  validates :skill_type, presence: true, inclusion: { in: %w[character_intro drill kanji_intro grammar_intro vocabulary grammar reading listening review writing speaking authentic_reading pragmatics contrastive_grammar classical_japanese] }
